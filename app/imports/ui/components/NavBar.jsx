          ...
          {this.props.currentUser ? (
              [<Menu.Item as={NavLink} activeClassName="active" exact to="/add" key='add'>Add Food</Menu.Item>,
                ...
                <Menu.Item as={NavLink} activeClassName="active" exact to="/contact" key='contact'>Contact
                  Us</Menu.Item>,
                <Menu.Item as={NavLink} activeClassName="active" exact to="/results" key='list'>Search Results</Menu.Item>]
          ) : ''}
          {Roles.userIsInRole(Meteor.userId(), 'admin') ? (
              <Menu.Item as={NavLink} activeClassName="active" exact to="/admin" key='admin'>Admin</Menu.Item>
          ) : ''}
          {Roles.userIsInRole(Meteor.userId(), 'admin') ? (
              <Menu.Item as={NavLink} activeClassName="active" exact to="/adminreport" key='adminreport'>
                General Feedback</Menu.Item>
          ) : ''}
